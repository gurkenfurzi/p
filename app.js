...
function stickerHTML(e){
 ...
 if(kind==='pin')return`<div class="sticker-root sticker-pin" style="${style}"><svg viewBox="0 0 130 170"><path d="M37 44c0-20 15-35 34-35s34 15 34 35c0 11-5 21-13 27l-4 3c-10 7-24 7-34 0l-4-3c-8-6-13-16-13-27Z" fill="${acc}" stroke="#735b57" stroke-width="4"/><circle cx="59" cy="28" r="9" fill="#fff" opacity=".65"/><circle cx="77" cy="58" r="4" fill="#f7c7d3" opacity=".8"/><path d="M71 77v58" stroke="#8a8a8a" stroke-width="6" stroke-linecap="round"/><path d="M65 136h12l-6 18z" fill="#696969"/></svg></div>`;
 if(kind==='pushpin')return`<div class="sticker-root sticker-pin" style="${style}"><svg viewBox="0 0 130 170"><path d="M49 52h46l-7 22H56z" fill="${col}" stroke="#735b57" stroke-width="4" stroke-linejoin="round"/><rect x="47" y="20" width="50" height="26" rx="13" fill="${acc}" stroke="#735b57" stroke-width="4"/><circle cx="58" cy="29" r="6" fill="#fff" opacity=".55"/><path d="M71 74v63" stroke="#898989" stroke-width="6" stroke-linecap="round"/><path d="M65 138h12l-6 18z" fill="#6a6a6a"/></svg></div>`;
 ...
 if(kind==='title_1')return`<div class="sticker-root sticker-title1" style="${style}"><svg viewBox="0 0 1000 260" preserveAspectRatio="none"><polygon points="0,130 110,20 110,240" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linejoin="round"/><polygon points="1000,130 890,20 890,240" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linejoin="round"/><rect x="180" y="18" width="640" height="164" rx="10" fill="${col}" stroke="${acc}" stroke-width="${sw}"/><path d="M180 182 110 238V182M820 182 890 238V182" fill="color-mix(in srgb, ${acc} 28%, ${col})" stroke="${acc}" stroke-width="${sw}" stroke-linejoin="round"/></svg><div class="sticker-text" style="transform:translate(${e.stickerTextX||0}px,${e.stickerTextY||0}px)">${txt||'Add Title Here'}</div></div>`;
 if(kind==='title_2')return`<div class="sticker-root sticker-title2" style="${style}"><svg viewBox="0 0 1000 280" preserveAspectRatio="none"><polygon points="0,145 120,40 120,250" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linejoin="round"/><polygon points="1000,145 880,40 880,250" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linejoin="round"/><path d="M180 28 Q500 -6 820 28 L820 182 Q500 150 180 182 Z" fill="${col}" stroke="${acc}" stroke-width="${sw}"/><path d="M180 182 120 236V182M820 182 880 236V182" fill="color-mix(in srgb, ${acc} 26%, ${col})" stroke="${acc}" stroke-width="${sw}" stroke-linejoin="round"/></svg><div class="sticker-text" style="transform:translate(${e.stickerTextX||0}px,${e.stickerTextY||0}px)">${txt||'Add Title Here'}</div></div>`;
...
const stickerCatalog=[
 ...
 {kind:'title_1',name:'Title 1',cat:'decor',pack:'titles',w:470,h:150,desc:'Breites Ribbon-Banner'},
 {kind:'title_2',name:'Title 2',cat:'decor',pack:'titles',w:500,h:160,desc:'Gebogenes Ribbon-Banner'},
 {kind:'note_sheet',name:'Note',cat:'paper',pack:'titles',w:360,h:280,desc:'Liniert oder Karo, skalierbar'},
