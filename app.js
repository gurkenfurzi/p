...
function stickerHTML(e){
 ...
 if(kind==='pin')return`<div class="sticker-root sticker-pin-ref" style="${style}"><svg viewBox="0 0 330 700" preserveAspectRatio="xMidYMid meet"><circle cx="165" cy="165" r="155" fill="${col}" stroke="${acc}" stroke-width="${Math.max(3,sw*2)}"/><circle cx="215" cy="95" r="42" fill="${detail}" stroke="${acc}" stroke-width="${Math.max(3,sw*1.8)}"/><rect x="145" y="325" width="40" height="340" rx="20" fill="${detail}" stroke="${acc}" stroke-width="${Math.max(3,sw*1.8)}"/></svg></div>`;
 if(kind==='pushpin')return`<div class="sticker-root sticker-pin-ref" style="${style}"><svg viewBox="0 0 360 520" preserveAspectRatio="xMidYMid meet"><g transform="rotate(16 185 260)"><rect x="155" y="272" width="42" height="220" rx="21" fill="${detail}" stroke="${acc}" stroke-width="${Math.max(3,sw*1.8)}"/><circle cx="180" cy="195" r="92" fill="${col}" stroke="${acc}" stroke-width="${Math.max(3,sw*2)}"/><path d="M138 190 160 118 222 134 210 205C195 214 173 220 150 213Z" fill="color-mix(in srgb, ${col} 82%, white)" stroke="none" opacity=".95"/><ellipse cx="213" cy="76" rx="86" ry="58" fill="color-mix(in srgb, ${col} 88%, white)" stroke="${acc}" stroke-width="${Math.max(3,sw*1.8)}"/></g></svg></div>`;
 ...
 if(kind==='title_1'){const left=`<svg viewBox="0 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M275.66,287.16H7.2l84.69-96.12L3.55,119.12h269.4c1.46,56.01,1.26,112.03,2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><polygon points="187.04 232.49 276.89 287.53 276.55 231.82 187.04 232.49" fill="color-mix(in srgb, ${acc} 28%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;const right=`<svg viewBox="739 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M739.58,287.16h268.47s-84.69-96.12-84.69-96.12l88.34-71.92h-269.4c-1.46,56.01-1.26,112.03-2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><polygon points="828.21 232.49 738.36 287.53 738.69 231.82 828.21 232.49" fill="color-mix(in srgb, ${acc} 28%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;return`<div class="sticker-root sticker-title-smart variant-1 no-text" style="${style}"><div class="title-left">${left}</div><div class="title-mid"></div><div class="title-right">${right}</div></div>`;}
 if(kind==='title_2'){const left=`<svg viewBox="1563 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M1835.66,286.91h-268.47l84.69-96.12-88.34-71.92h269.4c1.46,56.01,1.26,112.03,2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><path d="M1747.04,232.23l89.85,55.05c-.11-20.85-.22-41.69-.33-62.54-29.84,2.5-59.68,4.99-89.52,7.49Z" fill="color-mix(in srgb, ${acc} 28%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;const right=`<svg viewBox="2299 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M2299.58,286.91h268.47s-84.69-96.12-84.69-96.12l88.34-71.92h-269.4c-1.46,56.01-1.26,112.03-2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><path d="M2388.21,232.23l-89.85,55.05c.14-20.73.28-41.46.42-62.2l89.44,7.15Z" fill="color-mix(in srgb, ${acc} 28%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;return`<div class="sticker-root sticker-title-smart variant-2 no-text" style="${style}"><div class="title-left">${left}</div><div class="title-mid"></div><div class="title-right">${right}</div></div>`;}
 if(kind==='title_3'){const left=`<svg viewBox="0 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M275.66,287.16H7.2l84.69-96.12L3.55,119.12h269.4c1.46,56.01,1.26,112.03,2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><polygon points="187.04 232.49 276.89 287.53 276.55 231.82 187.04 232.49" fill="color-mix(in srgb, ${acc} 28%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;const right=`<svg viewBox="739 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M739.58,287.16h268.47s-84.69-96.12-84.69-96.12l88.34-71.92h-269.4c-1.46,56.01-1.26,112.03-2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><polygon points="828.21 232.49 738.36 287.53 738.69 231.82 828.21 232.49" fill="color-mix(in srgb, ${acc} 28%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;return`<div class="sticker-root sticker-title-smart variant-3 no-text" style="${style}"><div class="title-left">${left}</div><div class="title-mid"></div><div class="title-right">${right}</div></div>`;}
 if(kind==='title_4'){const left=`<svg viewBox="0 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M275.66,287.16H7.2l84.69-96.12L3.55,119.12h269.4c1.46,56.01,1.26,112.03,2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><polygon points="187.04 232.49 276.89 287.53 276.55 231.82 187.04 232.49" fill="color-mix(in srgb, ${acc} 28%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;const right=`<svg viewBox="739 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M739.58,287.16h268.47s-84.69-96.12-84.69-96.12l88.34-71.92h-269.4c-1.46,56.01-1.26,112.03-2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><polygon points="828.21 232.49 738.36 287.53 738.69 231.82 828.21 232.49" fill="color-mix(in srgb, ${acc} 28%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;return`<div class="sticker-root sticker-title-smart variant-4 no-text" style="${style}"><div class="title-left">${left}</div><div class="title-mid"></div><div class="title-right">${right}</div></div>`;}
 if(kind==='note_sheet'){const holes=Array.from({length:6},(_,i)=>`<i class="hole" style="top:${14+i*14}%"></i>`).join('');return`<div class="sticker-root sticker-note-smart ${notePattern==='grid'?'grid':'lined'}" style="${style}"><div class="note-back"></div><div class="note-front"><div class="note-paper"><div class="note-holes">${holes}</div><div class="note-pattern"></div>${txt?`<div class="sticker-text" style="transform:translate(${e.stickerTextX||0}px,${e.stickerTextY||0}px)">${txt}</div>`:''}</div></div></div>`;}
 ...
 if(kind==='note_top_torn'||kind==='note_top_torn_2'||kind==='note_top_torn_3'||kind==='note_top_torn_4'){const holesCfg={note_top_torn:[7,'small'],note_top_torn_2:[7,'ring'],note_top_torn_3:[5,'big'],note_top_torn_4:[5,'big']};const [count,type]=holesCfg[kind]||[7,'small'];const dots=Array.from({length:count},(_,i)=>`<i class="${type}" style="left:${count===5?10+i*20:9+i*12.5}%"></i>`).join('');return`<div class="sticker-root sticker-topstrip-smart ${kind}" style="${style}"><div class="strip-paper"></div><div class="strip-holes">${dots}</div></div>`;}
 if(kind==='window_square')return`<div class="sticker-root sticker-ui-window win-square" style="${style}"><div class="win-back"></div><div class="win-front"><div class="win-bar"><div class="win-spacer"></div><div class="win-btns"><i></i><i></i><i></i></div></div><div class="win-screen"></div></div></div>`;
 if(kind==='window_wide')return`<div class="sticker-root sticker-ui-window win-wide" style="${style}"><div class="win-front"><div class="win-bar"><div class="win-spacer"></div><div class="win-btns"><i></i><i></i><i></i></div></div><div class="win-screen"></div></div></div>`;
 if(kind==='folder_window')return`<div class="sticker-root sticker-ui-window win-folder" style="${style}"><div class="folder-tab"></div><div class="win-front"><div class="win-bar"><div class="folder-search"></div><div class="win-btns"><i></i><i></i><i></i></div></div><div class="win-screen"></div></div></div>`;
 if(kind==='window_square_2')return`<div class="sticker-root sticker-ui-window win-square tall-bar" style="${style}"><div class="win-front"><div class="win-bar"><div class="win-spacer"></div><div class="win-btns"><i></i><i></i><i></i></div></div><div class="win-screen"></div></div></div>`;
 if(kind==='window_wide_2')return`<div class="sticker-root sticker-ui-window win-wide rounded-soft" style="${style}"><div class="win-front"><div class="win-bar"><div class="win-spacer"></div><div class="win-btns"><i></i><i></i><i></i></div></div><div class="win-screen"></div></div></div>`;
 if(kind==='folder_window_2')return`<div class="sticker-root sticker-ui-window win-folder alt" style="${style}"><div class="folder-tab"></div><div class="win-front"><div class="win-bar"><div class="folder-search"></div><div class="win-btns"><i></i><i></i><i></i></div></div><div class="win-screen"></div></div></div>`;
 if(kind==='paint_window')return`<div class="sticker-root sticker-ui-window win-paint" style="${style}"><div class="win-back"></div><div class="win-front"><div class="paint-title">Paint</div><div class="win-btns"><i></i><i></i><i></i></div><div class="paint-body"><div class="paint-tools"><div class="brush-box"></div><div class="palette-grid"></div></div><div class="paint-slider"></div><div class="paint-canvas"></div></div><div class="paint-bottom"></div></div></div>`;
...
function renderElement(e,editable=false){
 ...
 if(editable&&!e.locked){
  ...
  if(e.type==='sticker'&&!['tape','washi','paperclip','binder','pin','pushpin','sparkle','sparklegif','heartgif','leaf','ruler','bow','daisy','arrowdoodle','squiggle','frame_window','frame_blob','frame_scallop','title_1','title_2','title_3','title_4','window_square','window_wide','folder_window','window_square_2','window_wide_2','folder_window_2','paint_window','note_top_torn','note_top_torn_2','note_top_torn_3','note_top_torn_4'].includes(e.stickerKind)){d.addEventListener('dblclick',ev=>{ev.stopPropagation();const t=c.querySelector('.sticker-text,.caption');if(!t)return;t.contentEditable='true';t.focus();selectText(t);t.onblur=()=>{t.contentEditable='false';e.content=t.textContent;commit();renderSlides();renderInspector()}})}
...
const stickerCatalog=[
 ...
 {kind:'title_3',name:'Title 3',cat:'decor',pack:'titles',w:560,h:160,desc:'Breites Ribbon wie PNG 03'},
 {kind:'title_4',name:'Title 4',cat:'decor',pack:'titles',w:440,h:150,desc:'Kompaktes Ribbon wie PNG 04'},
 {kind:'note_sheet',name:'Note Lined',cat:'paper',pack:'titles',w:360,h:280,desc:'Referenz-Notizblatt mit Löchern'},
 {kind:'notebook',name:'Notebook',cat:'paper',pack:'titles',w:320,h:340,desc:'Spiralblock aus der Datei'},
 {kind:'note_top_torn',name:'Paper Strip 1',cat:'paper',pack:'titles',w:340,h:180,desc:'Oben gelochter Papierstreifen 1'},
 {kind:'note_top_torn_2',name:'Paper Strip 2',cat:'paper',pack:'titles',w:340,h:180,desc:'Oben gelochter Papierstreifen 2'},
 {kind:'note_top_torn_3',name:'Paper Strip 3',cat:'paper',pack:'titles',w:340,h:180,desc:'Oben gelochter Papierstreifen 3'},
 {kind:'note_top_torn_4',name:'Paper Strip 4',cat:'paper',pack:'titles',w:340,h:180,desc:'Oben gelochter Papierstreifen 4'},
 {kind:'window_square',name:'Window 1',cat:'decor',pack:'ui',w:250,h:220,desc:'Fenster aus PNG 01'},
 {kind:'window_wide',name:'Window 2',cat:'decor',pack:'ui',w:350,h:180,desc:'Fenster aus PNG 02'},
 {kind:'folder_window',name:'Folder 1',cat:'decor',pack:'ui',w:350,h:220,desc:'Folder aus PNG 03'},
 {kind:'window_square_2',name:'Window 3',cat:'decor',pack:'ui',w:260,h:260,desc:'Fenster aus PNG 04'},
 {kind:'window_wide_2',name:'Window 4',cat:'decor',pack:'ui',w:350,h:180,desc:'Fenster aus PNG 05'},
 {kind:'folder_window_2',name:'Folder 2',cat:'decor',pack:'ui',w:350,h:220,desc:'Folder aus PNG 06'},
...
function stickerElement(kind){
 ...
 if(['title_1','title_2','title_3','title_4'].includes(kind))e.content='';
 if(['note_sheet','notebook','note_top_torn','note_top_torn_2','note_top_torn_3','note_top_torn_4','window_square','window_wide','folder_window','window_square_2','window_wide_2','folder_window_2','paint_window'].includes(kind))e.content='';
