...
function applyUIAccent(color){if(!color)return;uiAccent=color;document.documentElement.style.setProperty('--accent',color);STORE.setItem('slidebloom_v6_ui_accent',color);if($('#appAccentColor'))$('#appAccentColor').value=color}
