...
function stickerHTML(e){
 ...
 if(kind==='pin')return`<div class="sticker-root sticker-pin-ref" style="${style}"><svg viewBox="0 0 340 780" preserveAspectRatio="xMidYMid meet"><rect x="149.48" y="261.01" width="33.33" height="428.07" rx="16.67" ry="16.67" fill="${detail}" stroke="${acc}" stroke-width="${Math.max(3,sw*2.1)}"/><circle cx="166.15" cy="166.15" r="159.65" fill="${col}" stroke="${acc}" stroke-width="${Math.max(3,sw*2.1)}"/><circle cx="218.52" cy="91.59" r="41.23" fill="#fef5f9" stroke="${acc}" stroke-width="${Math.max(3,sw*2)}"/></svg></div>`;
 if(kind==='pushpin')return`<div class="sticker-root sticker-pin-ref" style="${style}"><svg viewBox="1450 0 390 780" preserveAspectRatio="xMidYMid meet"><g transform="rotate(16 1670 360)"><rect x="1575.59" y="396.16" width="38.28" height="382.93" rx="19.14" ry="19.14" fill="${detail}" stroke="${acc}" stroke-width="${Math.max(3,sw*2.1)}"/><ellipse cx="1666.18" cy="357.41" rx="152.84" ry="182.71" fill="${col}" stroke="${acc}" stroke-width="${Math.max(3,sw*2.1)}"/><path d="M1582 330c18 24 44 45 76 55 47 14 86-3 94-8l84-285-170-50-84 288Z" fill="${detail}" opacity=".72" stroke="none"/><ellipse cx="1720.75" cy="171.13" rx="93.17" ry="126.06" fill="${col}" stroke="${acc}" stroke-width="${Math.max(3,sw*2.1)}"/><circle cx="1747" cy="129" r="18" fill="#fef5f9" opacity=".85"/></g></svg></div>`;
 ...
 if(kind==='title_1'){const left=`<svg viewBox="0 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M275.66,287.16H7.2l84.69-96.12L3.55,119.12h269.4c1.46,56.01,1.26,112.03,2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><polygon points="187.04 232.49 276.89 287.53 276.55 231.82 187.04 232.49" fill="color-mix(in srgb, ${acc} 35%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;const right=`<svg viewBox="739 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M739.58,287.16h268.47s-84.69-96.12-84.69-96.12l88.34-71.92h-269.4c-1.46,56.01-1.26,112.03-2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><polygon points="828.21 232.49 738.36 287.53 738.69 231.82 828.21 232.49" fill="color-mix(in srgb, ${acc} 35%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;return`<div class="sticker-root sticker-title-smart variant-1" style="${style}"><div class="title-left">${left}</div><div class="title-mid"></div><div class="title-right">${right}</div><div class="sticker-text" style="transform:translate(${e.stickerTextX||0}px,${e.stickerTextY||0}px)">${txt||'Add Title Here'}</div></div>`;}
 if(kind==='title_2'){const left=`<svg viewBox="1563 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M1835.66,286.91h-268.47l84.69-96.12-88.34-71.92h269.4c1.46,56.01,1.26,112.03,2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><path d="M1747.04,232.23l89.85,55.05c-.11-20.85-.22-41.69-.33-62.54-29.84,2.5-59.68,4.99-89.52,7.49Z" fill="color-mix(in srgb, ${acc} 35%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;const right=`<svg viewBox="2299 0 276 288" preserveAspectRatio="xMidYMid meet"><path d="M2299.58,286.91h268.47s-84.69-96.12-84.69-96.12l88.34-71.92h-269.4c-1.46,56.01-1.26,112.03-2.72,168.04Z" fill="${col}" stroke="${acc}" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round"/><path d="M2388.21,232.23l-89.85,55.05c.14-20.73.28-41.46.42-62.2l89.44,7.15Z" fill="color-mix(in srgb, ${acc} 35%, ${col})" stroke="${acc}" stroke-width="${Math.max(1,sw*.8)}" stroke-linecap="round" stroke-linejoin="round"/></svg>`;return`<div class="sticker-root sticker-title-smart variant-2" style="${style}"><div class="title-left">${left}</div><div class="title-mid"></div><div class="title-right">${right}</div><div class="sticker-text" style="transform:translate(${e.stickerTextX||0}px,${e.stickerTextY||0}px)">${txt||'Add Title Here'}</div></div>`;}
 if(kind==='note_sheet'){const holes=Array.from({length:6},(_,i)=>`<i class="hole" style="top:${12+i*14}%"></i>`).join('');return`<div class="sticker-root sticker-note-smart ${notePattern==='grid'?'grid':'lined'}" style="${style}"><div class="note-back"></div><div class="note-front"><div class="note-holes">${holes}</div><div class="note-paper"><div class="note-pattern"></div>${txt?`<div class="sticker-text" style="transform:translate(${e.stickerTextX||0}px,${e.stickerTextY||0}px)">${txt}</div>`:''}</div></div></div>`;}
 ...
 if(kind==='note_top_torn'){const dots=Array.from({length:7},(_,i)=>`<i style="left:${8+i*12}%"></i>`).join('');return`<div class="sticker-root sticker-topstrip-smart" style="${style}"><div class="strip-paper"></div><div class="strip-holes">${dots}</div>${txt?`<div class="sticker-text" style="transform:translate(${e.stickerTextX||0}px,${e.stickerTextY||0}px)">${txt}</div>`:''}</div>`;}
...
function renderInspector(){
 ...
 if(e.type==='sticker'){set('#stickerTextInput',e.content||'');set('#stickerColor',safeColor(e.stickerColor||e.fill||'#fff8ef'));set('#stickerAccentColor',safeColor(e.stickerAccent||'#e8d7a7'));set('#stickerDetailColor',safeColor(e.stickerDetailColor||'#d9dde6'));set('#stickerTextX',e.stickerTextX||0);set('#stickerTextY',e.stickerTextY||0);set('#stickerStrokeWidth',e.stickerStrokeWidth||6);set('#notePattern',e.notePattern||'lined');set('#milestoneNumber',e.milestoneNumber||'01');if(timelineKinds.includes(e.stickerKind)){set('#timelinePoints',e.timelinePoints||4);set('#timelineStart',e.timelineStart??0);set('#timelineStep',e.timelineStep??1);set('#timelineUnit',e.timelineUnit||'Jahre');set('#timelineLabels',(e.timelineLabels||'').replace(/\|/g,'\n'))}}
...
function stickerElement(kind){
 ...
 if(kind==='notebook'){e.stickerColor='#fef5f9';e.stickerAccent='#c8568e'}if(timelineKind){e.timelinePoints=4;e.timelineStart=0;e.timelineStep=1;e.timelineUnit='Jahre';e.timelineLabels=''}
...
function renderStickerGrid(cat='all'){
 ...
 const q=($('#stickerSearch')?.value||'').trim().toLowerCase();const hiddenKinds=new Set(['highlight','foldertab','tab','squiggle','frame_scallop','binder','daisy','mini_calendar']);
